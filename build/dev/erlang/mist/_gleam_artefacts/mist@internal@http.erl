...
?DOC(false).
-spec add_date_header(gleam@http@response:response(JLY)) -> gleam@http@response:response(JLY).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(JMB)) -> gleam@http@response:response(JMB).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(JME)) -> gleam@http@response:response(JME).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(JMH)) -> gleam@http@response:response(JMH).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(JMM)) -> gleam@http@response:response(JMM)).
