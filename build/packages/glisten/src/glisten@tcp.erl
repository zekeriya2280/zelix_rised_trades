...
set_opts(Socket, Opts) ->
    ...
    glisten_tcp_ffi:set_opts(Socket, _pipe@1).
...
listen(Port, Opts) ->
    ...
    gen_tcp:listen(Port, _pipe@2).

-file("src/glisten/tcp.gleam", 80).
